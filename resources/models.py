...
class Resource(models.Model):
    ...
    capabilities = ArrayField(
        models.CharField(max_length=50, blank=True), size=18, default=list
    )
    ...
    availableUnits = models.PositiveSmallIntegerField(
        default=1
    ...
    locationURL = models.URLField(
        max_length=300,
        null=True,
        default="https://www.google.com/maps/d/u/0/viewer?mid=1kgubHXowj8c08ZAUqjlIMpbmugo&hl=en&ll=35.18135920444196%2C-111.64538796598629&z=16",
    )
