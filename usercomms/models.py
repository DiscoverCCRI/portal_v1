...
class Usercomms(models.Model):
    ...
    reference_user = models.ForeignKey(
        User,
        related_name="usercomms_reference_user",
    ...
    sender = models.ForeignKey(
        User,
        related_name="usercomms_sender",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    receivers = models.ManyToManyField(User, related_name="usercoms_receivers")
    is_hidden = models.BooleanField(default=False)
    is_removed = models.BooleanField(default=False)
    created_by = models.ForeignKey(
        User,
        related_name="usercomms_created_by",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
