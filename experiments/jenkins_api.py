...
JENKINS_EXAMPLE_REPO = 'https://gitlab.flux.utah.edu/powder-profiles/srslte-docker-sim.git'

logger = logging.getLogger(__name__)


def deploy_experiment(experiment, host):
    if experiment.stage.upper() == 'DEVELOPMENT': #experiment.state == Experiment.STATE_PROVISIONING and
        params = {
            'host': host,
            'repo': JENKINS_EXAMPLE_REPO
        }
