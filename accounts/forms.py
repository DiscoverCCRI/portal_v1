...
from .models import (AerpawRoleRequest, AerpawUser, AerpawUserRoleChoice,
                     AerpawUserSignup)
...
class AerpawRoleRequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ("requested_role", "purpose")

    requested_role = forms.ChoiceField(widget=forms.Select, label="Requested Role")
